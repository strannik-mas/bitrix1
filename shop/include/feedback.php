...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/shop/about/idea/",
            "PATH_IDEA_POST" => "/shop/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/shop/login/?forgot_password=yes",
            "REGISTER_URL" => "/shop/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
