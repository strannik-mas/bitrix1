...
Class dev_module extends CModule
{
    ...
    $this->MODULE_VERSION = '0.1';
                $this->MODULE_VERSION_DATE = '2013-03-15';
                $this->MODULE_NAME = "dev_module – свой модуль с компонентом";
                $this->MODULE_DESCRIPTION = 'После установки вы сможете пользоваться своим компонентом news.detail';
    }
    ...
    {
        CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/dev_module/install/components", $_SERVER["DOCUMENT_ROOT"]."/bitrix/components/spec/", true, true);
        return true;
    }
    function UnInstallFiles()
    {
        DeleteDirFilesEx("/bitrix/components/spec/news.detail/");
        return true;
    }
